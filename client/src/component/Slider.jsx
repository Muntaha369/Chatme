    ...
    <div className="relative min-h-screen bg-slate-900 text-white overflow-hidden">
      ...
      */}
      <motion.div
        ...
        className="fixed top-0 left-0 h-screen w-[370px] bg-emerald-600 shadow-2xl flex flex-col items-center justify-center z-40"
      >
        ...
        <button 
          onClick={() => setIsOpen(false)}          className="mt-8 px-4 py-2 bg-emerald-800 hover:bg-emerald-900 rounded text-sm"
        >
          Close Me
        </button>
      </motion.div>
